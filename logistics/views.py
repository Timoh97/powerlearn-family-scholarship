...
def request_summary(request):
    ...
    message = get_template('').render(context) #transport_summary_email.html
    msg = EmailMessage(
        subject,
        message,
    ...
    return render(request,'', context)  #request_summary.html
...
def summaries(request):
    ...
    return render(request,'', context)  #summaries.html
...
def approval(request, request_summary_id):
    ...
    message = get_template('').render(context) #transport_approval_email.html
    msg = EmailMessage(
        subject,
        message,
        settings.EMAIL_HOST_USER,
